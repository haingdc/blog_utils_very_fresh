...
import WrapperAlert from "./demo/_WrapperAlert.tsx";
  ...
  return (
    <div class="h-full w-full flex flex-col gap-8 p-6">
      ...
      <div class="flex flex-col gap-3">
        ...
        <div
          class={`h-[${preview_h}px] p-4 border rounded-xl grid ${place_class} relative`}
        >
          {children}
        </div>
      </div>
      <div class="flex flex-col">
        ...
        <code
          class="shj-lang-ts py-4 px-6 mb-6 rounded-xl overflow-x-scroll"
          style={`font-size:.875rem!important; line-height:1.25rem!important`}
          dangerouslySetInnerHTML={{
            __html: highlightText(code_text, "ts", false),
          }}
        >
        </code>
      </div>
